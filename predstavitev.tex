...
\begin{definicija}
    Realno zaporedje $(a_n)$ \emph{Ces\`{a}ro konvergira}, če konvergira njegovo zaporedje aritmetičnih sredin $(\overline{a}_n)$. V takem primeru limiti zaporedja $(\overline{a}_n)$ pravimo \emph{Ces\`{a}ro limita zaporedja $(a_n)$}.
\end{definicija}
...
V prvem letniku smo se pri analizi naučili, da iz $a_n \rightarrow a$ sledi $a_n \leadsto a$. Obratno seveda ne velja, saj zaporedje $\left( (-1)^n \right)$ Ces\`{a}ro konvergira proti $0$, ne konvergira pa v običajnem smislu. Ker je pojem Ces\`{a}ro konvergence zelo pomemben za nadaljevanje, si oglejmo še nekaj primerov.
...
\begin{zgled}
    ...
    zato velja $\overline{a}_n \rightarrow 0$ oziroma $a_n \leadsto 0$. Če pa zaporedje $(a_n)$ pomnožimo s samim seboj, dobimo zaporedje, ki ni Ces\`{a}ro konvergentno.
\end{zgled}
...
\begin{definicija}
    Funkcija $f: \mathbb{R} \rightarrow \mathbb{R}$ je \emph{Ces\`{a}ro zvezna v točki $a \in \mathbb{R}$}, če za vsako zaporedje $(a_n)$, ki Ces\`{a}ro konvergira proti $a$, zaporedje $(f(a_n))$ Ces\`{a}ro konvergira proti $f(a)$. Pravimo, da je $f$ \emph{Ces\`{a}ro zvezna}, če je Ces\`{a}ro zvezna v vsaki točki $a \in \mathbb{R}$.
\end{definicija}
